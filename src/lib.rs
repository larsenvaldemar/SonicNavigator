// src/lib.rs
/*
 * Core library for SonicNavigator
 */
...
#[derive(Debug)]
pub struct SonicNavigatorProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SonicNavigatorProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SonicNavigator processing");
    
    let mut processor = SonicNavigatorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SonicNavigatorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SonicNavigatorProcessor::new(false);
